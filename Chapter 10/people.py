...
#
    def get_information(self) :
        informationString = "%s, %s" % (self._name, self._year)
...
#
    def get_information(self) :
        informationString = "%s, born %d is a %s major" % (self._name, self._year, self._major)
        return informationString
...
#
    def get_information(self) :
        informationString = "%s, born in %d has a $%.2f salary" % (self._name, self._year, self._salary)
        return informationString
